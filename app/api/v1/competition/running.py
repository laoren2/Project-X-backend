...
from app.services.competition.running import (
    ...
    query_current_season_service, cancel_register_service,
...
# 查询赛事详情
@router.get("/query_event_detail", response_model=BaseResponse[RunningEventBaseInfo], summary="查询running赛事详情")
...
@router.get("/query_incompleted_records",response_model=BaseResponse[RunningRecordResponse],summary="查询当前赛季未开始记录")
...
@router.get("/query_completed_records",response_model=BaseResponse[RunningRecordResponse],summary="查询当前赛季已结束记录")
