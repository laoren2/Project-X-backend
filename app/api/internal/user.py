...
async def get_anyone_card(
    ...
    return BaseResponse.success(message="成功获取用户信息卡片", data=PersonInfoResponse(user_id=userInfo.user_id, avatar_image_url=userInfo.avatar_image_url, nickname=userInfo.nickname))