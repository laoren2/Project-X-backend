...
from app.schemas.competition.running import (
    ...
    RunningSeasonCreateForm, RunningUnverifiedRecordResponse, RunningRouteApplicationListInternalResponse
)
...
# 查询热门路线转赛道申请
@router.get("/query_route_applications", response_model=BaseResponse[RunningRouteApplicationListInternalResponse], summary="查询热门路线转赛道申请")
